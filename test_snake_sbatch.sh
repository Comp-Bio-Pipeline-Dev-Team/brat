...
#SBATCH --job-name=test_picardCollect_rnaSeq_07102025
#SBATCH --output=logs/07102025/test_picardCollect_rnaSeq_%J.log
...
#SBATCH --error=logs/07102025/test_picardCollect_rnaSeq_%J.err
