...
#SBATCH --time=03:00:00 # 2h, madi edit: had to up the time so the job wasn't canceled
...
#SBATCH --job-name=test_star_alignment_rule
#SBATCH --output=logs/06182025/test_starAlignment_rule_%J.log
#SBATCH --mem=1G # suffix K,M,G,T can be used with default to M, madi edit: uses <5G 
#SBATCH --mail-user=MADISON.APGAR@CUANSCHUTZ.EDU
#SBATCH --mail-type=FAIL,END
#SBATCH --error=logs/06182025/test_starAlignment_rule_%J.err
