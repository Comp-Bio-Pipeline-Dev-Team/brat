...
## actual command
brat \
    --raw_seq_dir '/scratch/alpine/mapgar@xsede.org/test_outside/test_seqs/' \
    --metadata_file '/scratch/alpine/mapgar@xsede.org/test_outside/test_samp_metadata.tsv' \
    --out_dir_name 'test' \
    --profile '/scratch/alpine/mapgar@xsede.org/test_outside/slurm_profile.yml' \
